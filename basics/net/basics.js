...
const HttpServer = http.createServer((req, res) => {
    ...
    PartThree = fs.readFileSync("./client/html/Bottom.html"); //reading a file with the function 'readFileSync' of the 'fs' Object will block the further execution of the program
